#  MINLP written by GAMS Convert at 02/15/18 11:43:52
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         31        9        0       22        0        0        0        0
...
m.sc9 = Var(within=CannotHandle,bounds=(0.03,0.11),initialize=0)
 in {0} union interval[0.03, 0.11]m.sc10 = Var(within=CannotHandle,bounds=(0.04,0.1),initialize=0)
 in {0} union interval[0.04, 0.1]m.sc11 = Var(within=CannotHandle,bounds=(0.04,0.07),initialize=0)
 in {0} union interval[0.04, 0.07]m.sc12 = Var(within=CannotHandle,bounds=(0.03,0.11),initialize=0)

    in {0} union interval[0.03, 0.11]m.sc13 = Var(within=CannotHandle,bounds=(0.03,0.2),initialize=0)
 in {0} union interval[0.03, 0.2]m.sc14 = Var(within=CannotHandle,bounds=(0.03,0.1),initialize=0)
 in {0} union interval[0.03, 0.1]m.sc15 = Var(within=CannotHandle,bounds=(0.03,0.1),initialize=0)

    in {0} union interval[0.03, 0.1]m.sc16 = Var(within=CannotHandle,bounds=(0.02,0.2),initialize=0)
 in {0} union interval[0.02, 0.2]m.sc17 = Var(within=CannotHandle,bounds=(0.02,0.15),initialize=0)
 in {0} union interval[0.02, 0.15]m.sc18 = Var(within=CannotHandle,bounds=(0,0),initialize=0)

    in {0} union interval[0, 0]m.sc19 = Var(within=CannotHandle,bounds=(0,0),initialize=0)
 in {0} union interval[0, 0]m.sc20 = Var(within=CannotHandle,bounds=(0.04,0.1),initialize=0)
 in {0} union interval[0.04, 0.1]m.sc21 = Var(within=CannotHandle,bounds=(0.04,0.15),initialize=0)
 in {0} union interval[0.04
   , 0.15]m.sc22 = Var(within=CannotHandle,bounds=(0.04,0.2),initialize=0)
 in {0} union interval[0.04, 0.2]m.b23 = Var(within=Binary,bounds=(0,1),initialize=0)
